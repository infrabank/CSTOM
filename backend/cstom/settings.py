"""
Django settings for cstom project.
...
WSGI_APPLICATION = "cstom.wsgi.application"
...
if DATABASE_URL:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "cstom"),
            "USER": os.getenv("POSTGRES_USER", "cstom"),
