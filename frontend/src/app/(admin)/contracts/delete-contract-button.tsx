        ...
        footer={
          <>
            <button
              ...
              disabled={isDeleting}
              className="px-4 py-2 text-black bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50"
            >
              취소
            </button>
            <button
      ...
      >
        <div className="space-y-3">
          <p className="text-black">
            정말로 <span className="font-semibold text-black">{contractName}</span> 사업을 삭제하시겠습니까?
          </p>
